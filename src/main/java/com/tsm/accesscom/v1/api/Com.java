package com.tsm.accesscom.v1.api;
...
import com.tsm.accesscom.v1.exception.AccessComException;
...
public class Com implements AccessCom {
	...
	//final static Logger logger = Logger.getLogger(Com.class);
     ...
     * @throws com.tsm.accesscom.v1.exception.AccessComException if any error ocurrs during the call.
     */
