...
public class TsmConfigurationReader {

    /* Creating the Logger */
    //private static final Logger LOG = LoggerFactory.getLogger(TsmConfigurationReader.class);
    ...
    public String getProperty(String key) throws IllegalArgumentException {
        try {
                ...
                InputStream in = classLoader.getResourceAsStream("tsm.properties");
    ...
    public static void setConfigReader(Properties configReader) {
        TsmConfigurationReader.configReader = configReader;
    }
